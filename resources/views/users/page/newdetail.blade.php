...
@section('content')
<nav aria-label="breadcrumb" class="breadcrumb-nav mb-3 border-0 mb-0">
    <div class="container">
        <ol class="breadcrumb">
                ...
                <article class="entry single-entry">
                    <div class="entry-body">
                        ...
                        <div class="entry-content editor-content">
                            ...
                            <img src="users/assets/images/blog/single/2.jpg" alt="image" class="float-left">
                            ...
                            <img src="users/assets/images/blog/single/3.jpg" alt="image">
                    ...
                    <div class="entry-author-details">
                        <figure class="author-media">
                            <a href="#">
                                <img src="users/assets/images/blog/single/author.jpg" alt="User name">
                            </a>
                    ...
                    <div class="owl-carousel owl-simple" data-toggle="owl" 
                        ...
                        <article class="entry entry-grid">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="users/assets/images/blog/grid/3cols/post-1.jpg" alt="image desc">
                                </a>
                        ...
                        <article class="entry entry-grid">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="users/assets/images/blog/grid/3cols/post-2.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry entry-grid">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="users/assets/images/blog/grid/3cols/post-3.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry entry-grid">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="users/assets/images/blog/grid/3cols/post-4.jpg" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                    ...
                    <ul>
                        <li>
                            <div class="comment">
                                <figure class="comment-media">
                                    <a href="#">
                                        <img src="users/assets/images/blog/comments/1.jpg" alt="User name">
                                    </a>
                                </figure>
                            ...
                            <ul>
                                <li>
                                    <div class="comment">
                                        <figure class="comment-media">
                                            <a href="#">
                                                <img src="users/assets/images/blog/comments/2.jpg" alt="User name">
                                            </a>
                                        </figure>
                        ...
                        <li>
                            <div class="comment">
                                <figure class="comment-media">
                                    <a href="#">
                                        <img src="users/assets/images/blog/comments/3.jpg" alt="User name">
                                    </a>
                                </figure>
                ...
                <div class="sidebar">
                    ...
                    <div class="widget">
                        ...
                        <ul class="posts-list">
                            <li>
                                <figure>
                                    <a href="#">
                                        <img src="users/assets/images/blog/sidebar/post-1.jpg" alt="post">
                                    </a>
                                </figure>
                            ...
                            <li>
                                <figure>
                                    <a href="#">
                                        <img src="users/assets/images/blog/sidebar/post-2.jpg" alt="post">
                                    </a>
                                </figure>
                            ...
                            <li>
                                <figure>
                                    <a href="#">
                                        <img src="users/assets/images/blog/sidebar/post-3.jpg" alt="post">
                                    </a>
                                </figure>
                            ...
                            <li>
                                <figure>
                                    <a href="#">
                                        <img src="users/assets/images/blog/sidebar/post-4.jpg" alt="post">
                                    </a>
                                </figure>
                    ...
                    <div class="widget widget-banner-sidebar">
                        ...
                        <div class="banner-sidebar">
                            <a href="#">
                                <img src="users/assets/images/blog/sidebar/banner.jpg" alt="banner">
                            </a>
                        </div><!-- End .banner-ad -->
                    </div><!-- End .widget -->
