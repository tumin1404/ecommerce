                    ...
                    <div class="product-gallery product-gallery-vertical">
                        <div class="row">
                            <figure class="product-main-image">
                                <img id="product-zoom" src="users/assets/images/products/single/centered/1.jpg" data-zoom-image="assets/images/products/single/centered/1-big.jpg" alt="product image">
                            ...
                            <div id="product-zoom-gallery" class="product-image-gallery">
                                <a class="product-gallery-item active" href="#" data-image="assets/images/products/single/centered/1.jpg" data-zoom-image="assets/images/products/single/centered/1-big.jpg">
                                    <img src="users/assets/images/products/single/centered/1-small.jpg" alt="product side">
                                </a>
                                ...
                                <a class="product-gallery-item" href="#" data-image="assets/images/products/single/centered/2.jpg" data-zoom-image="assets/images/products/single/centered/2-big.jpg">
                                    <img src="users/assets/images/products/single/centered/2-small.jpg" alt="product cross">
                                </a>
                                ...
                                <a class="product-gallery-item" href="#" data-image="assets/images/products/single/centered/3.jpg" data-zoom-image="assets/images/products/single/centered/3-big.jpg">
                                    <img src="users/assets/images/products/single/centered/3-small.jpg" alt="product with model">
                                </a>
                                ...
                                <a class="product-gallery-item" href="#" data-image="assets/images/products/single/centered/4.jpg" data-zoom-image="assets/images/products/single/centered/4-big.jpg">
                                    <img src="users/assets/images/products/single/centered/4-small.jpg" alt="product back">
                                </a>
        ...
        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow product-4-carousel" data-toggle="owl" 
                        ...
                        <div class="product product-4 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="users/assets/images/products/elements/5cols/product-1.jpg" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-4 text-center product-disabled">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="users/assets/images/products/elements/5cols/product-2.jpg" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-4 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="users/assets/images/products/elements/5cols/product-3.jpg" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-4 text-center">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="users/assets/images/products/elements/5cols/product-4.jpg" alt="Product image" class="product-image">
                                </a>
                        ...
                        <div class="product product-4 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="users/assets/images/products/elements/5cols/product-5.jpg" alt="Product image" class="product-image">
                                </a>
